...
WEBAPP_REPORTS_JSON_DIR = Path("webapp") / "reports_json"
WEBAPP_DAILY_JSON_OUTPUT_DIR = WEBAPP_REPORTS_JSON_DIR / "daily"
WEBAPP_SELECTED_JSON_OUTPUT_DIR = WEBAPP_REPORTS_JSON_DIR / "selected"
